...
import { Flashings } from './collections/Flashings'
import { Templates } from './collections/Templates'
import { JobReferences } from './collections/JobReferences'
import { Orders } from './collections/Orders'
import { Factories } from './collections/Factories'
import { SupportRequests } from './collections/SupportRequests'
import { AdjustRequests } from './collections/AdjustRequests'
...
export default buildConfig({
  cookiePrefix: process.env.PAYLOAD_COOKIE_PREFIX || 'ff',
  admin: {
    components: {
