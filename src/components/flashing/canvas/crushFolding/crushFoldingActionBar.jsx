...
const CrushFoldingActionBar = ({ onHelp }) => (
  <motion.div
  ...
  >
    <div className="flex items-center gap-2 bg-[#D9E2FF] rounded-md px-3 py-[10.5px]">
      <h3 className="grow font-roboto text-xs/[22.5px] text-primary-dark">
        <span className="font-bold">Crush Fold.</span> Crush Folds are typically added at the end of
        the process. Choose the start/end to add a crush fold
      </h3>
...
export default CrushFoldingActionBar
