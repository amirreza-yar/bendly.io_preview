...
const RemovingActionBar = ({ onHelp }) => (
  <motion.div
  ...
  >
    <div className="flex items-center gap-2 bg-[#D9E2FF] rounded-md px-3 py-[10.5px]">
      <h3 className="grow font-roboto text-xs/[22.5px] text-primary-dark">
        <span className="font-bold">Remove.</span> Select line(s) first, then
        tap trash at the top to remove.
      </h3>
...
export default RemovingActionBar;
