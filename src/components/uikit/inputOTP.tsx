...
function InputOTPSlot({
  ...
  return (
    <div
      ...
      className={cn(
        'data-[active=true]:border-ring data-[active=true]:ring-ring/50 data-[active=true]:aria-invalid:ring-destructive/20 aria-invalid:border-destructive data-[active=true]:aria-invalid:border-destructive  border-input relative flex h-11 w-11 items-center justify-center border-[2px] rounded-md text-[16px]/[19px] font-semibold transition-all outline-none data-[active=true]:z-10 data-[active=true]:border-primary',
        className,
      )}
      {...props}
    >
