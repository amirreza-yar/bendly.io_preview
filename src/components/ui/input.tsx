  ...
  return (
    <input
      ...
      className={cn(
        ...
        "aria-invalid:placeholder:text-destructive/70 aria-invalid:text-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
        className,
      )}
      {...props}
    />
