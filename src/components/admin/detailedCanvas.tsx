...
import { createAngleAnnotationObj, getAllCircles } from '@/utilities/canvas/canvasUtils'
import { IconButton } from '../uikit/buttons/iconButton'
import { Crosshair, Ruler, RulerBold, Taper, TaperBold, XIcon } from '../uikit/icons'
...
export default function DetailedCanvas({
  ...
  const createAnnotations = (setOriginalAngle) => {
    ...
    const lines = canvas.getObjects().filter((o) => o.type === 'line' && (o.circle1 || o.circle2))
