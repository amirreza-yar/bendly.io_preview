...
export type AddNewMaterialFormValues = z.infer<typeof DetailsFormSchema>

export default function AddNewMaterialForm({
  onAddNewMaterialFormSubmit,
}: {
  onAddNewMaterialFormSubmit: (data: AddNewMaterialFormValues) => void
}) {
  const form = useForm<AddNewMaterialFormValues>({
  ...
  return (
    <>
      <Form {...form}>
        <form id="edit-material-form" onSubmit={form.handleSubmit(onAddNewMaterialFormSubmit)}>
          <div className="flex justify-between gap-6">
            <div className="flex flex-col">
              <h6>Properties and cost</h6>
              <p className="subtitle-regular py-3">Edit material name or cost.</p>
