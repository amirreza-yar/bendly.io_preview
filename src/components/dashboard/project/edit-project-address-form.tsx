...
export default function EditAddressForm({
  ...
  const editAddressForm = useForm<z.infer<typeof editAddressFormSchema>>({
  ...
  const handleEditProjectAddressSubmit = async (
    data: z.infer<typeof editAddressFormSchema>,
  ) => {
    const res = await onPatchAddress({
      projectId: projectId,
  ...
  return (
    <form
      onSubmit={editAddressForm.handleSubmit(handleEditProjectAddressSubmit)}
      className="h-full"
    >
