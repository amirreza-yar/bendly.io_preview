...
const TapperingTopBar = () => {
  const { setIsTaperingDrawerOpen } = useTapperingContext()
  ...
  return (
    ...
    >
      <div className="flex justify-between items-center bg-white h-[56px] px-0.5">
        <IconButton variant="ghost" black className="hover:bg-white" onClick={handleClose}>
          <XIcon />
        </IconButton>
...
export default TapperingTopBar
