    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-gray-900">
      <div className='flex flex-col w-full h-full -md md:-lg  mx-auto shadow-md p-4 sm:p-6 md:p-8 lg:p-10 xl:p-12 rounded-none sm:rounded-lg'>
        <div className="w-full min-h-screen  bg-white shadow-md p-4 sm:p-6 md:p-8 rounded-none sm:rounded-lg">
          ...
          <h5 className="text-xmd font-bold pb-4">Verify Your Mobile Number</h5>
          <p className="text-gray-600 text-sm pt-1.5">We sent a 5-digit code to:</p>
 
          <div className="mt-2 flex justify-center">
            <div className="relative w-[180px] h-[36px] rounded-[40px] border border-gray-300 bg-gray-100 flex items-center justify-center">
