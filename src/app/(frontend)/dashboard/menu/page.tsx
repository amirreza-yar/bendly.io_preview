...
export default function MenuPanel() {
  ...
  return (
    <div
      className={`fixed inset-0 z-50 bg-black/50 transition-opacity duration-300 ${'opacity-100 pointer-events-auto'}`}
    >
      <div
        className={`absolute top-0 w-full h-full bg-[#eee] transition-transform duration-300 ${'translate-x-0'}`}
      >
        ...
        <div className="flex flex-col justify-start items-center flex-grow w-full pb-4">
          <div className="flex flex-col justify-start items-start self-stretch flex-grow-0 flex-shrink-0 gap-2">
            <div className="flex flex-col justify-start items-start self-stretch flex-grow-0 flex-shrink-0 gap-3 px-4 pt-4 pb-1 bg-white">
            ...
            <div className="flex flex-col justify-start items-center self-stretch flex-grow-0 flex-shrink-0 gap-3 px-4 pt-4 pb-1 bg-white">
              <div className="flex justify-start items-start self-stretch flex-grow-0 flex-shrink-0 relative gap-2">
                <p className="flex-grow-0 flex-shrink-0 text-base font-semibold text-left text-neutral-900">
                  Help &amp; Support
                </p>
