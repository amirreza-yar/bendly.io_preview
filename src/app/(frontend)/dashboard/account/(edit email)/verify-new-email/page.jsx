    ...
    <div className="flex flex-col w-full h-full">
      <div className="w-full min-h-screen  bg-white shadow-md p-4 sm:p-6 md:p-8 rounded-none sm:rounded-lg">
        ...
        <div className="text-center mb-10 pt-5.5">
          <h5 className="text-xmd font-bold pb-4">Verify Your New Email</h5>
          <p className="text-gray-600 text-sm pt-1.5">We've sent a 5-digit code to your new email addressh:</p>
