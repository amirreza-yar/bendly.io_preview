...
export default function MenuPanel() {
  ...
  return (
    ...
    >
      ...
      >
        <div className={`bg-surface-card p-4 border-b-1 border-b-border-dark flex items-center gap-xl transition-all duration-700 ${
          isClosing ? 'delay-0' : 'delay-100'
        } ${
          isVisible && !isClosing ? 'translate-y-0 opacity-100' : 'translate-y-[-20px] opacity-0'
        }`}>
        ...
        <div className="flex flex-col justify-start items-center flex-grow w-full pb-4">
          <div className="flex flex-col justify-start items-start self-stretch flex-grow-0 flex-shrink-0 gap-2">
            <div className={`flex flex-col justify-start items-start self-stretch flex-grow-0 flex-shrink-0 gap-3 px-4 pt-4 pb-1 bg-white transition-all duration-700 ${
              ...
              <div className="flex justify-between items-center self-stretch flex-grow-0 flex-shrink-0 h-12 bg-white cursor-pointer hover:bg-gray-100">
                <div className="flex flex-col justify-center items-start flex-grow">
                  <Drawer trigger={<ButtonListItem text="Measurement" icon={Ruler} />}>
                    <div className="flex flex-col p-6">
                      ...
                      <div
                        className={cn(
                          'flex items-center justify-between p-4 h-16',
                          measurement === 'imperial' && 'bg-surface-comp-active',
                        )}
            ...
            <div className={`flex flex-col justify-start items-center self-stretch flex-grow-0 flex-shrink-0 gap-3 px-4 pt-4 pb-1 bg-white transition-all duration-700 ${
