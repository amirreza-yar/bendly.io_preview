...
export default function VerifyCurrentMobilePage() {
  ...
  const onSubmitVerifyMobile = async (data: VerifyPhoneOTPValue) => {
    ...
    // }
    // console.log(res)
    router.push(`/dashboard/account/verified-mobile?mobile=${newMobile}`)
  }
      ...
      <ContentWrapper className="pt-24">
        <div className="grid gap-6 items-center">
          <div className="grid items-center text-center gap-2">
            <h5>Verify Your Current Mobile</h5>
            <p className="subtitle-regular">
              We've sent a 5-digit code to your current mobile number:
            </p>
